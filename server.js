...
// La clave API se lee de las variables de entorno en Render
...
// =============================================
// RUTA: CHAT CON PULPO (USANDO GEMINI)
// =============================================
app.post('/api/chat', async (req, res) => {
  ...
  try {
    // El conocimiento base de PULPO
    const contexto = `
      Eres PULPO, el agente de IA del TDI (Talento Digital Inteligente).
      Tu personalidad: amigable, experto, servicial, con toque de humor.
      
      Conocimiento del SAI:
      - Sistema de Automatización de Ingresos
      - Tarjetas digitales con QR, botones y carrusel
      - Planes: Básico ($25k), Intermedio ($50k), Avanzado ($100k), Premium ($200k)
      - Guía Digital de Cúcuta
      - Sistema de referidos con comisiones
      
      Responde con claridad, entusiasmo y siempre invita a la acción.
    `;
